            ...
            <table class="table" id="userTbl">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Aktualní stav</th>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a title="Prohlédnout příspěvek" href="view.php?id=<?php echo $r['id']?>">
                            <i class="fas fa-eye"></i>
                        </a>
                    
                    <?php if ($r['pristup']) { ?>
                        <a title="Prohlédnout posudek" href="posudek.php?id=<?php echo $r['id']?>">
