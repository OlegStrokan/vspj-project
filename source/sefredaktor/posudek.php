...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="table-test table-view">
            <h4>Posudek oponenta</h4>
       
            <label>Autor</label><br>
            <input type="text" value=" <?php echo $r2['username'];?>" readonly="true" /><br>
            
            <label>Aktuálnost, zajímavost a přínosnost</label><br>
            <input type="text" value=" <?php echo $r['aktualnost'];?>" readonly="true" /><br>

            <label>Originalita</label><br>
            <input type="text" value=" <?php echo $r['originalita'];?>" readonly="true" /><br>

            <label>Odborná úroveň</label><br>
            <input type="text" value=" <?php echo $r['odb_uroven'];?>" readonly="true" /><br>

            <label>Jazyková a stylistická úroveň</label><br>
            <input type="text" value=" <?php echo $r['jaz_uroven'];?>" readonly="true" /><br>
            
            <label>Posudek</label>
            <br>
            <textarea name="posudek" readonly="true"><?php echo $r['posudek'] ?></textarea>
            <br>
            <label>Celkový závěr</label>
            <br>
            <input id="zaver" type="text" value=" <?php echo $r['zaver'];?>" readonly="true" />
            <br>
            <br>
