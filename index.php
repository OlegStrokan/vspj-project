                ...
                <div class="col-xs-12 col-sm-3 col-md-4 col-lg-3 pull-right login-home">
                    <form enctype="application/x-www-form-urlencoded" action="" method="post">
                            ...
                            if(isset($_SESSION['role'])){ ?>
                                Jste přihlašen jako: <strong> <?php echo $_SESSION['login_user']; ?></strong>
                            <?php } else { ?>
                                    ...
                                    <input type="submit" name="tlacitko" id="tlacitko" value="Přihlášení" class="btn btn-danger">
                                    <span style="font-size:12px; color:red; margin-top:10px">
                                        <?php echo $error; ?>
                                    </span>
                                    <a href="./registrace/"><input name="tlacitko2" id="tlacitko2" value="Založit účet" class="btn btn-light"></a>
                            <?php } ?>
                    </form>
                </div>
            </div>
